...
maxTrials = 50; 	// n trials per block
...
changePadding = 5; 	// number of trials at the beginning/end of each block in which a visual change cannot occur. 
					//i.e. changes can occur from trial changePadding + 1 : maxTrials - changePadding
...
function displayFeedback(){	
	...
	writeTrialData(); //moved to fix problems with asynchronous code execution
