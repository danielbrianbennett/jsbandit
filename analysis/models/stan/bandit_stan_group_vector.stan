...
vector[nBandits] banditMean[nSubjects,nBlocks,nTrials];
vector[nBandits] banditVariance[nSubjects,nBlocks,nTrials];
vector[nBandits] deltaFunction[nSubjects,nBlocks,nTrials];
vector[nBandits] bonus[nSubjects,nBlocks,nTrials];
vector[nBandits] kalmanGain[nSubjects,nBlocks,nTrials];
vector[nBandits] choiceProb[nSubjects,nBlocks,nTrials];
